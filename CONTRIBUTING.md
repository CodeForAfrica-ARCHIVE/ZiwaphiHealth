...
Please read the following guidelines before you [report an issue](https://github.com/CodeForAfrica/HealthWatch/issues/):
...
**[File a bug report](https://github.com/CodeForAfrica/HealthWatch/issues/)**
...
2. Clone your fork (`git clone
   https://github.com/<your-username>/HealthWatch.git`).

3. Add an `upstream` remote (`git remote add upstream
   https://github.com/CodeForAfrica/HealthWatch.git`).
